...
var ReactCarouselDots = function (_React$Component) {
  _inherits(ReactCarouselDots, _React$Component);

  function ReactCarouselDots(props) {
    _classCallCheck(this, ReactCarouselDots);
    ...
    _this.componentWillReceiveProps = function (nextProps) {
      ...
      if (nextProps.active > _this.props.active) {
        ...
        if (nextProps.length - 3 < nextProps.active) {
          _this.setState({ translate: (nextProps.length - (nextProps.visible + 1)) * (nextProps.size + 2 * nextProps.margin) });
        }
        if (_this.state.direction === 'forwards') {
          ...
          if (_this.state.changed) {
            ...
            newBigDots = _this.getNewBigDots(nextProps, false);
            _this.setState({ bigDots: newBigDots, translate: (nextProps.active - (nextProps.visible - 2)) * (nextProps.size + 2 * nextProps.margin), direction: 'forwards' });
          }
        ...
        if (nextProps.length - nextProps.visible < nextProps.active) {
          _this.setState({ bigDots: newBigDots, translate: (nextProps.length - (nextProps.visible + 1)) * (nextProps.size + 2 * nextProps.margin) });
        }
        if (_this.state.direction === 'backwards') {
          ...
          if (_this.state.changed) {
            ...
            // Simply set the direction and the transform
            newBigDots = _this.getNewBigDots(nextProps, false);
            _this.setState({ bigDots: newBigDots, translate: (nextProps.active - 2) * (nextProps.size + 2 * nextProps.margin), direction: 'backwards' });
          }
          ...
          if (nextProps.visible > 4) {
            ...
            newBigDots = _this.getNewBigDots(nextProps, false);
            _this.setState({ direction: 'backwards', bigDots: newBigDots });
          }
        }
      }
    };
      ...
      if (nextProps.active >= _this.props.active) {
        if (nextProps.visible % 2 === 1) {
          if (nextProps.active < nextProps.visible - 2) {
            for (var j = 0; j < nextProps.visible - 1; j += 1) {
              newBigDots.push(j);
            }
            ...
            for (var _j2 = nextProps.length - nextProps.visible; _j2 < nextProps.length; _j2 += 1) {
              newBigDots.push(_j2);
            }
          } else if (!changed) {
            for (var _j3 = nextProps.active - (nextProps.visible - 3); _j3 < nextProps.active + 2; _j3 += 1) {
              newBigDots.push(_j3);
            }
          } else {
          ...
          for (var _j4 = 0; _j4 < nextProps.visible - 1; _j4 += 1) {
            newBigDots.push(_j4);
          }
        } else if (nextProps.active === nextProps.visible - 2) {
          for (var _j5 = 0; _j5 < nextProps.visible; _j5 += 1) {
            newBigDots.push(_j5);
          }
        } else if (nextProps.length - 4 < nextProps.active) {
          for (var _j6 = nextProps.length - nextProps.visible; _j6 < nextProps.length; _j6 += 1) {
            newBigDots.push(_j6);
          }
        } else if (!changed) {
          for (var _j7 = nextProps.active - (nextProps.visible - 3); _j7 < nextProps.active + 2; _j7 += 1) {
            newBigDots.push(_j7);
          }
        } else {
          newBigDots = _this.state.bigDots;
        ...
        if (nextProps.active < nextProps.visible - (nextProps.visible - 3)) {
          for (var _j8 = 0; _j8 < nextProps.visible - 1; _j8 += 1) {
            newBigDots.push(_j8);
          }
        } else if (nextProps.length - nextProps.visible < nextProps.active) {
          for (var _j9 = nextProps.length - nextProps.visible; _j9 < nextProps.length; _j9 += 1) {
            newBigDots.push(_j9);
          }
        } else if (!changed) {
          for (var _j10 = nextProps.active - 1; _j10 < nextProps.active + (nextProps.visible - 2); _j10 += 1) {
        ...
        for (var _j11 = 0; _j11 < nextProps.visible - 1; _j11 += 1) {
          newBigDots.push(_j11);
        }
      } else if (nextProps.length - 4 < nextProps.active) {
        for (var _j12 = nextProps.length - nextProps.visible; _j12 < nextProps.length; _j12 += 1) {
          newBigDots.push(_j12);
        }
      } else if (!changed) {
        for (var _j13 = nextProps.active - 1; _j13 < nextProps.active + (nextProps.visible - 2); _j13 += 1) {
    ...
    _this.getDotStyle = function () {
      ...
      if (_this.state.direction === 'forwards') {
        if (_this.props.active < _this.props.visible - 2) {
          ...
          style = _extends({}, style, {
            transform: 'translateX(-' + (_this.props.length - (_this.props.visible + 1)) * (_this.props.size + 2 * _this.props.margin) + 'px)'
          });
        } else if (!_this.state.changed) {
          style = _extends({}, style, {
            transform: 'translateX(-' + (_this.props.active - (_this.props.visible - 2)) * (_this.props.size + 2 * _this.props.margin) + 'px)'
          });
        } else {
          style = _extends({}, style, {
        ...
        style = _extends({}, style, {
          transform: 'translateX(-' + (_this.props.active - 2) * (_this.props.size + 2 * _this.props.margin) + 'px)'
        });
      } else {
        style = _extends({}, style, {
          transform: 'translateX(-' + _this.state.translate + 'px)'
    ...
    _this.getHolderStyle = function () {
      ...
      if (_this.state.direction === 'forwards') {
        if (_this.props.active < _this.props.visible - 2) {
          style = _extends({}, style, {
            width: _this.props.size * _this.props.visible + _this.props.visible * _this.props.margin * 2
          });
        } else {
          style = _extends({}, style, {
            width: _this.props.size * (_this.props.visible + 1) + (_this.props.visible + 1) * _this.props.margin * 2
          });
        }
    ...
    _this.getDotClassName = function (index) {
      if (_this.state.bigDots.includes(index)) {
        if (index === (0, _lodash.min)(_this.state.bigDots) || index === (0, _lodash.max)(_this.state.bigDots)) {
          return 'medium';
        }
        return '';
      }
    ...
    _this.state = {
      direction: 'forwards',
      bigDots: _this.getNewBigDots(props),
      changed: false,
      changeCount: 0,
      translate: 0
    };
...
ReactCarouselDots.propTypes = {
  ...
  visible: _propTypes2.default.number,
